...
export default function CtaSection({ ctaHref, authAwareCta = false }: CtaSectionProps) {
  ...
  return <section className="relative overflow-hidden border-t border-white/[.07] px-5 py-24 text-center sm:px-8 sm:py-32 lg:px-12"><Image alt="" fill sizes="100vw" src="/images/cta-studio-mobile.png" className="object-cover object-center md:hidden" /><Image alt="" fill sizes="100vw" src="/images/cta-studio-ambient.png" className="hidden object-cover object-center md:block" /><div aria-hidden="true" className="absolute inset-0 bg-black/30" /><div className="relative z-10 mx-auto max-w-3xl"><p className="text-xs font-semibold uppercase tracking-[.16em] text-white/40">La Musica</p><h2 className="mt-6 text-5xl font-semibold tracking-[-.06em] text-white sm:text-7xl">Your song is waiting.</h2><p className="mt-5 text-lg text-white/55">All you need is an idea.</p><div className="mt-9">{cta}</div></div></section>;
}
