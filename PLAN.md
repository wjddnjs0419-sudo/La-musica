...
## Done
- [Done] Auth-aware landing CTA label (2026-06-18) - Returning signed-in users now see `Open Workspace` on landing CTAs that already route to `/workspace`, while anonymous users keep `Get Started` to `/auth`. build/lint passed. See RESULT.md.
